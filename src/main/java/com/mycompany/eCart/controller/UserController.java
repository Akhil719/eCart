...
public class UserController {
	...
	public String getEditProfile(Model model) {
		log.info("inside edit User Profile ");
...
//		userDAO.updateUser(user);
		...
		System.err.println(user.getF_name());
		System.err.println(user.getL_name());
		System.err.println(user.getMobile());
		System.err.println("Exiting edit profile");
...
//		return "redirect:/updateProfile";
	...
	public String getUpdateProfile() {
		log.info("Update User Profile Called");
		String mail_id = session.getAttribute("user_email").toString();
		user = userDAO.getUser(mail_id);
		...
		if (updateStatus) {
			System.err.println("*************************************************************************************" );
			log.info("User Profile Updation is Successfull");
			return "redirect:/viewProfile";
		} else {
			/*
			 * System.out.println(user.getF_name());
			 * System.out.println(user.getL_name());
			 * System.out.println(user.getMobile()); model.addAttribute("user",
			 * user);
			 */
			System.err.println("*************************************************************************************");
			log.info("User Profile Updation is Successfull");
		...
		/*
		 * model.addAttribute("user", user); List<String> billsList =
		 * saveCartDAO.getBills(mail_id); model.addAttribute("billsList",
		 * billsList);
		 */
