...
public class CartController 
{
	...
	public String addToCart(@PathVariable("id") int id, HttpServletRequest request, Principal principal,Model model, HttpSession session) 
	{
	...
	public String buyNow(@PathVariable("id") int id, HttpServletRequest request, Principal principal,Model model, HttpSession session) 
	{
		log.info("Cart add function called.");
		try 
		{
